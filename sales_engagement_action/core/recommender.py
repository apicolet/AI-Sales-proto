...
from brevo_data_gatherer.config import load_config as load_script1_config
from brevo_data_gatherer.cache.manager import CacheManager as Script1Cache
...
from generate_deal_summary.core.ai_client import AIClient
from generate_deal_summary.core.summarizer import DealSummarizer
from generate_deal_summary.cache.manager import SummaryCache

# Local imports
from sales_engagement_action.cache.manager import RecommendationCache
from sales_engagement_action.models.schemas import RecommendationResult
...
class ActionRecommender:
    ...
    def _ensure_summary(self, enriched_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        from sales_engagement_action.config import DEFAULT_CACHE_DIR
    ...
    def _parse_recommendations(
        ...
        from sales_engagement_action.models.schemas import EngagementAnalysis
